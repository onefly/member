...
(function() {
	...
	var _vars = function(options) {
		...
		if (options.trustedOrigins) {
			...
			} else if (typeof options.trustedOrigins === "object"
					&& "length" in options.trustedOrigins) {
		...
		if (options.trustedDomains) {
			...
			} else if (typeof options.trustedDomains === "object"
	...
	ZeroClipboard.prototype.setCurrent = function(element) {
		...
		var useHandCursor = this.options.forceHandCursor === true
	...
	ZeroClipboard.prototype.receiveEvent = function(eventName, args) {
		...
		case "datarequested":
			var targetId = element.getAttribute("data-clipboard-target"), targetEl = !targetId ? null
		...
		if (this.handlers[eventName]) {
			...
			if (typeof func === "function") {
				_dispatchCallback(func, element, this, args,
