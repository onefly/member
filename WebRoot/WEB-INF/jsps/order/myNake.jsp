...
<script type="text/javascript">
	...
	//搜索按钮功能
	function searchList() {
		var url = "${pageContext.request.contextPath}/nakedOrder/getNakedOrderDiv.htm";
		$.ajax({
			url : url,
			type : "post", //请求类型
        ...
        <div id="Tab1" class="data">
          <div class="Menubox">
            <ul>
			  ...
			  <li><a href="${pageContext.request.contextPath}/nakedOrder/getNakedOrderList.htm"  class="hover">裸价体验订单</a></li>
            </ul>
          </div>
             ...
             <div id="con_one_2" class="two hover" >
              <div class="feeling">
                ...
                <div class="feeling_cent fixed" id="orderDivList">
                  <!-- 裸价体验列表展示div -->
                  <jsp:include page="nakedListDiv.jsp" />
