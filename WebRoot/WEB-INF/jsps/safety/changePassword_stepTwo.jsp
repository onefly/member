...
<script language=javascript>  
	...
	function link_commit(){
		...
		$.ajax({
			url : "<%=basePath%>/safety/submitCode.json",
			type : "get",
			data : {code:code_val},
			async : false,
			dataType : "json",
           ...
           <div class="verification_a" id="stepTwo">
              <div class="tionb_top tiona_top"> 您现在的密保邮箱是：${user.email }
                <dl class="tiona_top_cent">
                  ...
                  <dd>验证码邮件24小时有效，请尽快登录您的邮箱完成验证</dd>
                </dl>
              <a href="#" class="fas02" onclick="reSendEmail()">重新发送验证码邮件</a>
              <form action="<%=basePath%>/safety/submitCode.htm" id="submit_code">
